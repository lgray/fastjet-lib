...
public:
  ...
  Recluster() : _subjet_def(), _use_full_def(true), _single(true){}
  ...
  //
  // It's not totally clear what to do here: if "single" then this
  // should be a standard jet with a CSStructure, and if !single, this
  // should be a CompositeJetStructure. In doubt, we'll use the basic
  // type.
