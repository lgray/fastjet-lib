...
%
The current implementation of the $pp$ sequential-recombination
...
The recombination scheme is set by an \texttt{enum} of type
\texttt{RecombinationScheme}, and it is related to the choice of how to
recombine the 4-momenta of \texttt{PseudoJet}s during the clustering procedure.
...
As an example of how \texttt{Selector}s are used, suppose that we  have a vector of jets, \ttt{jets},
...
%----------------------------------------------------------------------
\section{Background eatimation and subtraction}
...
A common use of an estimation of the background is to subtract it from the
