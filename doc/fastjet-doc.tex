...
See the example program \ttt{example/fastjet\_example.cc} that is
distributed with the \ttt{FastJet} code. For the reader who is
familiar with \ttt{KtJet} \cite{KtJet}, the example program is also
given as it would be written for \ttt{KtJet}, in the file
\ttt{example/ktjet\_example.cc}.
