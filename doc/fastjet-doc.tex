...
\title{\sf FastJet user manual%
  \\ \large (for version
  3.2.0-devel%  %%%-VERSION-NUMBER (do not remove this comment; used
...
%
The \verb|NNH| class underlies the implementations of the Jade and
$\ee$ Cambridge plugins, while all three \verb|NN***| classes are used in
the VariableR contrib's plugin.
%
