...
%
While the update of the internal information is carried out in a
thread-safe manner, if sharing a background estimator instance for a
common event across multiple threads, those different threads will be
acting on the cache in ways that are likely to break the link between
