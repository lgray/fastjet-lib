...
\begin{verbatim}
 ...
 cd fastjet-X.Y.Z/
\end{verbatim}
(replacing of course \ttt{X.Y.Z} with the appropriate version number).
...
int main () {
  ...
  particles.push_back( PseudoJet(  95.0, 0, 0,  95.0) ); 
  particles.push_back( PseudoJet(   5.0, 0, 0,   5.0) ); 
  ...
  for (unsigned i = 0; i < jets.size(); i++) {
    ...
    for (unsigned j = 0; j < constituents.size(); j++) {
      cout << "    constituent " << j << ": "<< constituents[j].perp() << " " 
           << constituents[j].rap() << " " << constituents[j].phi() << endl; 
    }
  }
}
\end{lstlisting}
...
and E scheme recombination
        pt y phi
jet 0: 100 0 3.14159
    constituent 0: 100 0 3.14159
jet 1: 100 0 0
    constituent 0: 95 0 0
    constituent 1: 5 0 0
\end{verbatim}
