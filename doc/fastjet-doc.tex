...
\begin{figure}[tp]
  ...
  \caption{
    ...
    cache. \comment{Is this still correct, including cache? But maybe we
      anyway update with new computer for timings?}
    %
    ...
    $p_t > 5\GeV$ and sort them into decreasing $p_t$.\comment{still correct?}
    %
