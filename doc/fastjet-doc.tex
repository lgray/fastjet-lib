...
boosted top tagger, \ttt{fastjet::JHTopTagger} from \cite{Kaplan:2008ie}.
%
...
% two of the taggers proposed for the
% reconstruction of boosted two-body decays: the \ttt{fastjet::MassDropTagger}
% introduced in \cite{BDRS} and a rest-frame \ttt{fastjet::RestFrameNSubjettinessTagger}
