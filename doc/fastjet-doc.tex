...
%
% Version 2.3 consolidated the changes of 2.2beta, introduced a new build system (GNU autotools), a
...
advanced jet analyses, namely the Selector class, filters, taggers and
new background estimation classes.
%
Version~3 also added the D0-Run I cone plugin and support for native
jet algorithms to be run with $R>\pi/2$.

% 
% %
% Additionally it brought Selectors, revamped the background estimation
% structure with the introduction of the JetMedianBackgroundEstimator
% and GridMedianBackgroundEstimator classes;
% %
% it introduced Transformers, such as the Filter and a number of boosted
% object taggers, the join(...) function and means to represent jets
% with structure other than that originating from a ClusterSequence.
% %
