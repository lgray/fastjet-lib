...
\author{Matteo Cacciari,$^{1,2}$ Gavin P. Salam$^{1}$ and Gregory Soyez$^{3,4}$\\[10pt]
  \normalsize
  ...
  \normalsize
  $^4$Institut de Physique Th\'eorique, CEA Saclay, France
}
...
\item Then compile and run it with
\begin{verbatim}
