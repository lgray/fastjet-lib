...
%
Note that 4-vector areas are not currently correctly computed for Voronoi
areas of jets in sparse events (the 4-vector area of each Voronoi cell
is massless and points in the direction of the particle).
...
\begin{figure}[tp]
  \centering
  \includegraphics[width=0.32\textwidth]{figs/best-strategy-manual-akt}\hfill
  \includegraphics[width=0.32\textwidth]{figs/best-strategy-manual-cam}\hfill
  \includegraphics[width=0.32\textwidth]{figs/best-strategy-manual-kt}
...
\begin{figure}[t]
  ...
  \caption{Time required to perform the clustering of $N$ particles in
    ...
    particles.  
    %
    \comment{Keep old 3.0.1 timings (maybe only for akt) and add new timings}
  }
\label{fig:timings}
\end{figure}

\comment{UPDATE THIS TEXT WHEN NEW FIGURES ARE IN} 
%
