...
brief overview in what follows of the  taggers included in \fastjet.
...
3-pronged context,b is really a generic 2-body tagger, which can also be
used recursively to obtained multi-prong tagging.
%
