...
The \ttt{Filter} class handles both
\begin{lstlisting}
...
\end{lstlisting}
reclustering the jet's constituents
with the jet definition \ttt{subjet\_def} and using \ttt{selector} to
decide which of these subjets have to be kept. 
%
...
from the filtering has the following additional structural
information:
% 
