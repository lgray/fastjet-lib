...
\title{FastJet 2.1 user manual (in progress)}
...
\ttt{JetDefinition::Plugin}; the \ttt{JetDefinition} can then be used
as described above.
\begin{verbatim}
...
recombinations that leads to same final jets.

\comment{Example plugin jet finders are provided in such and such a
  location...}
