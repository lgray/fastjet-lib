...
MMmmpp: MM is the major version number, mm the minor version
number and pp the patch release.
%
Thus version 3.1.12 would be represented as 030112.
%
...
\begin{table}[bt]
  \begin{center}
    ...
    \caption{The more interesting of the various algorithmic
      ...
      \comment{Add the figure for the best strategy v. N and R}
    }
