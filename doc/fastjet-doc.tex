...
There is also a routine for estimating rapidity-dependence densities,
...
\end{lstlisting}
However, a better alternative is probably to use a {\sl local} range definition, 
...
median $p_t$ per unit area for each jet. It is useful whenever 
the background
distribution is expected to be non uniform in rapidity and, for instance 
in the case
...
\ttt{ClusterSequenceArea::get\_median\_rho\_and\_sigma}\ttt{()} ona jet-by-jet basis.
