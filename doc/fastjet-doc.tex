...
\ttt{reset\_extra\_info;} transfers ownership of the pointer to the
\ttt{PseudoJet}. This means that when the PseudoJet goes out of scope

 \comment{SET INSTEAD OF RESET??? CARRY ON HERE}
