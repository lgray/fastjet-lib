...
When using the constructor above, the jet radius used by the pruning clustering 
...
\end{lstlisting}
In this case, the jet definition \ttt{pruner\_jetdef} should normally have a radius
\ttt{Rpruner}
