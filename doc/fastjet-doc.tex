...
\ttt{PseudoJet::UserInfo} is discussed in
...
the user to derive a class from \ttt{PseudoJet::UserInfo} and
...
to be cast to the relevant derived class of  \ttt{UserInfo}, we also
