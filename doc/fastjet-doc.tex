...
\begin{verbatim}
  ...
  const fastjet::AreaDefinition & area_def() const ; 
...
Once a range has been chosen, the following methods, belonging either to
the base class \ttt{ClusterSequenceAreaBase} or to \ttt{ClusterSequenceArea}, 
are available:
\begin{verbatim}
  ...
  double empty_area(const RangeDefinition & range) const;
  ...
  double n_empty_jets(const RangeDefinition & range) const;
\end{verbatim}
