...
\begin{abstract}
  ...
  community. It also provides ways of determining jet
  areas. 
\end{abstract}
...
with $R=0.4$, \ttt{NlnNCam} beats the \ttt{N2TiledMinHeap} strategy
...
of his dynamic closest pair algorithm. We thank Markus Wobisch for
