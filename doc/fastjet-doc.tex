...
%   
%   SelectorMassMin(double Mmin);                      
%   SelectorMassMax(double Mmax);                      
%   SelectorMassRange(double Mmin, double Mmax);       
%   
...
brief overview in what follows of some of the implemented taggers.

%......................................................................
\subsubsection{The mass-drop tagger}

Introduced in \cite{BDRS} for the purpose of identifying a boosted Higgs
decaying into a $b\bar b$ pair, this is a 2-pronged tagger. It starts with a fat jet obtained
...
Note further that  \ttt{JHTopTagger} does not derive directly from 
 from \ttt{Transformer}, but from the
\ttt{fastjet::TopTaggerBase} class instead. This class (which itself derives
from \ttt{Transformer}) has been provided in the intent of suggesting a common
...
The benefits of the choice of providing a base class for top taggers will of course be
more evident when more than a single top tagger will have been implemented.

%......................................................................
\subsubsection{The Cambridge/Aachen subjet tagger}

The Cambridge/Aachen subjet
tagger~\cite{Butterworth:2009qa}, a 3-pronged tagger, can be obtained through the include
\begin{lstlisting}
...
singlet particle decaying to $N$ partons, can be obtained through the include
\begin{lstlisting}
  #include "fastjet/tools/NSubjettinessTagger.hh"s
\end{lstlisting}
Its description will follow in a later version of
this manual.
