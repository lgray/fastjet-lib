...
\begin{abstract}
  ...
  longitudinally invariant $k_t$ and Cambridge/Aachen jet finders,
  based in part on tools and methods from the Computational Geometry
  community. It also provides ways of determining jet areas. Other jet
  finders can be accessed from the FastJet interface using a plugin
  mechanism.
\end{abstract}
...
contamination. Finally external jet finders can be accessed through
...
\comment{perhaps} the anti-$k_t$ algorithm.
%
...
%
A plugin facility allows one to access external jet finders through
the \fastjet interface, and overlays \fastjet features such as areas
onto the external jet finders.
%
Plugins are included for the fortran PxCone code and for the CDF C++
JetClu and MidPoint cone jet finders (all infrared unsafe), as well as
...
%......................................................................
\subsection[$k_t$ jet finder]{$\boldsymbol{k_t}$ jet finder}
...
%......................................................................
\subsection{Cambridge/Aachen jet finder}
...
\begin{table}
  \begin{center}
    \begin{tabular}{l|l}\hline
      ...
      N \gtrsim 6000$), suitable only for the Cambridge jet finder\\ 
...
(and non-trivial), for example for the Cambridge/Aachen jet finder
...
\paragraph{Unclustered particles.}  User-supplied plugin jet finders
...
\item Active areas add a uniform background of extremely soft massless
  ...
  sensible jet finders are infrared safe), the presence of the ghosts
...
\item The Voronoi area of a jet is the sum of the Voronoi areas of its
  ...
  radius $R$ centred on the particle.
\end{itemize}
...
use of information specific to the jet finder in order to speed up the
...
% Currently only a single kind of area definition exists,
% which we refer to as an {\sl active} area~\cite{CSSAreas}, however
...
\ttt{ClusterSequenceAreaActiveArea}, 
\ttt{ClusterSequenceAreaActiveAreaExplicitGhosts}, 
\ttt{ClusterSequenceAreaPassiveArea},
\ttt{ClusterSequenceArea1GhostPassiveArea} or 
\ttt{ClusterSequenceAreaVoronoiArea} (all of them in the \ttt{fastjet}
...
The \ttt{RangeDefinition} class allows the user to set the rapidity-azimuth range
over which he wishes to study the areas of the jets. It has two
...
The following methods, belonging to the base class
\ttt{ClusterSequenceAreaBase}, are also accessible from
...
\begin{verbatim}
  ...
  /// fits a form pt_per_unit_area(y) = a + b*y^2 in the range |y| < maxrap. 
...
%======================================================================
\section{Plugin jet finders}
\label{sec:plugins}

It can be useful to have a common interface for a range of jet finders
beyond the $k_t$ and Cambridge algorithms, and it can also be useful
to use the area-measurement tools for these other jet finders. In
order to facilitate this, the \fastjet package provides a
\emph{plugin} facility, allowing almost any other jet finder to be
...
textual description of the jet finder and its options (e.g.\ radius,
...
Example plugin jet finders that are provided with \fastjet are the
...
\cite{PxCone}.  All three of these cone jet finders, though widely
...
SISCone~\cite{SISCone} is an implementation of a cone type jet finder.
...
permission to distribute their cone jet-finder codes as plugins for
fastjet. 
...
If the user wishes to introduce a new recombination scheme, they may
...
\bibitem{SISCone} G.~P.~Salam and G.~Soyez, in preparation; standalone
...
\bibitem{CSSAreas} M.~Cacciari,  G.~P.~Salam and G.~Soyez, in preparation.
