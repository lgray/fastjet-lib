...
handles both filtering and trimming. Its constructor
\begin{lstlisting}
...
$R_{\rm filt}={\rm min}(0.3,R_{b\bar{b}})$, with $R_{b\bar b}$ the
...
jet to avoid having recluster its constituents.
...
[rest of documentation still to be written]
