...
\ttt{JetMedianBackgroundEstimator}. The simplest way to construct it is:
\begin{lstlisting}
   #include "fastjet/tools/JetMedianBackgroundEstimator.hh"
   // ...

   // constructor for a JetMedianBackgroundEstimator that will use the
...
\ttt{JetMedianBackgroundEstimator} about the rescaling with the call
\begin{lstlisting}
   // tell the JetMedianBackgroundEstimator about the rescaling
...
alternative constructors to \ttt{JetMedianBackgroundEstimator}, together with
...
\begin{lstlisting}
  ...
  JetMedianBackgroundEstimator(const std::vector<PseudoJet> & jets, const Selector & rho_range);
...
The \ttt{JetMedianBackgroundEstimator} class is new to FastJet 3.0.
%
