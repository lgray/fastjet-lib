...
%
The \ttt{fastjet::Filter} class derives from \ttt{Transformer}, and can be
instantiated using
\begin{lstlisting}
  #include "fastjet/tools/Filter.hh"
  // ...
  Filter filter(JetDefinition subjet_def, Selector selector, double rho);
\end{lstlisting}
to obtain a filter/trimmer that reclusters the jet's
...
If the jet definition to be used to recluster the jet's constituents is to employ 
...
set, the input jet
must be the result of a cluster sequence with area support and
