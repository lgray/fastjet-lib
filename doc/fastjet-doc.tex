...
cone, there are two options for the second phase: one can apply a
`split--merge' (see e.g.\ Ref.\ \cite{RunII-jet-physics}) procedure,
which ensures that no particle ends up in more than one jet.
%
Or one can identify the highest-$p_t$ stable cone, call it a jet,
...
%......................................................................
\subsubsection{Default mode: with  a split--merge step}
...
%
This remains SISCone's default.
...
\end{lstlisting}
The value of the overlap parameter is then ignored and caching is not
available.
%
...
There can be interest trying out other choices of scale variable for
