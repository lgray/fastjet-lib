...
\title{FastJet 3.0beta1 user manual}
...
%
In this respect version 3.0alpha2 should be considered a snapshot of
...
\begin{lstlisting}
  ...
  has_properties_of<ToolName>();
  extra_properties<ToolName>();
\end{lstlisting}
...
%======================================================================
\section{Functions of \ttt{PseudoJet}'s}
...
another. Thiscould be for example the \ttt{BackgroundRescaling} (see
\ref{sec:BGE-positional}) used to parametrise the positional
dependence of the background --- and allowing to obtain a number
...
\end{lstlisting}
that allows to provide a description of the function and
\begin{lstlisting}
  TOut operator()(const PseudoJet &pj) const;
  vector<TOut> operator()(const vector<PseudoJet> &pjs) const;
\end{lstlisting}
