...
\end{lstlisting}
with and similarly taking as argument a templated
...
\ttt{/} acting 
on a \ttt{PseudoJet} and a \ttt{double} coefficient. Analagous
...
of non-central collisions, also in azimuth. With a wise choice for
