...
\begin{lstlisting}
  vector<int> seeds{12345,67890};
  ClusterSequenceArea csa(particles, jet_def, area_def.with_fixed_seeds(seeds));
\end{lstlisting}
...
\begin{lstlisting}
  ...
  unique_ptr<BackgroundEstimatorBase> local_bge(global_bge.copy());
  // set the particles on the local copy, using its operator() function
