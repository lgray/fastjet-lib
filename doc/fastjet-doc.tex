...
\title{FastJet 2.4.2 user manual}
...
\paragraph{Subjet analysis.} To obtain the set of subjets at a specific
$d_{\mathrm{cut}}$ scale inside a given jet, one may use the following
\ttt{ClusterSequence} member function:
\begin{lstlisting}
