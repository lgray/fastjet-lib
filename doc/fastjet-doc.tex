...
\ttt{ClusterSequenceWithArea} (rather than \ttt{ClusterSequence}, from
...
slow, se we also provide the \ttt{passive\_area} option, which makes
...
the ghosts. This is done via the class \ttt{fastjet::GhostedAreaSpec}
