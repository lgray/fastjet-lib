...
In our implementations, the \ttt{SharedPtr} object involves an atomic
...
values.
%
Both of these strategies can lead to timing overheads. 
...
\ttt{ClusterSequenceArea} can use ghosts generated using a
