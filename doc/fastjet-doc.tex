...
\item For the \ttt{Selector::sift(jets, jets\_that\_pass, jets\_that\_fail)} C++ member, the last two arguments are
  references to \ttt{vector<PseudoJet>} objects.
  %
  In this case, it is not possible (in version 3.3) to use a Python
  list in place of those arguments. 
  %
