...
\footnote{It is tempting to define also a \ttt{WTA\_E\_scheme} in
  ...
  scheme is not provided in \fastjet. A similar consideartion applies
...
search and removal over and over until no particles remain, or no new
stable cones are found (we call
