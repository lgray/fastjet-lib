...
plot '../mass-tests/highlumi-r0.7.res'              u ($1+binshift):2    w fs lt 2 lw 2 t  'k_t, no pileup'

replot '../mass-tests/highlumi-r0.7.res'              u ($1+binshift):4    w fs lt 3 lw 2 t  'k_t, high lumi'

`gnupr zmass-series-01.eps col`

replot '../mass-tests/cone-highlumi-r0.7-all.res'     u ($1+binshift):4    w fs lt 4 lw 2 t  'ILCA cone (f = 0.50), high lumi'

`gnupr zmass-series-02.eps col`

replot     '../mass-tests/cone075-highlumi-r0.7-all.res'  u ($1+binshift):4    w fs lt 5 lw 2 t  'ILCA cone (f = 0.75), high lumi'

`gnupr zmass-series-03.eps col`



  plot '../mass-tests/zerolumi-noMI-r0.7.res' u ($1+binshift):2 w fs lt 1 lw 2 t 'kt, no UE'
replot '../mass-tests/highlumi-r0.7.res'      u ($1+binshift):2    w fs lt 2 lw 2 t  '+ UE'
replot '../mass-tests/highlumi-r0.7.res'      u ($1+binshift):4    w fs lt 3 lw 2 t  '+ high-lumi (100 fb^{-1}/yr)'

`gnupr zmass-series-04.eps col`

replot '../mass-tests/highlumi-r0.7.res'      u ($1+binshift):5    w fs lt -1 lw 3 t  '{/Symbol -} correction'

`gnupr zmass-series-05.eps col`
