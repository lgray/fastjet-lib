...
set ylabel 'A_{cone,R}({/Symbol D}_{12}) / {/Symbol p}R^2'
...
replot '2point-areas-active-cone-numerical.res' i 0 u 1:($3/pi) w l t ''
replot '2point-areas-active-cone-numerical.res' i 0 u 1:($3/pi):($4/pi) w yerr t ''
replot '2point-areas-active-cone-numerical.res' i 1 u 1:($3/pi):($4/pi) w yerr t ''
replot '2point-areas-active-cone-numerical.res' i 2 u 1:($3/pi):($4/pi) w yerr t ''
