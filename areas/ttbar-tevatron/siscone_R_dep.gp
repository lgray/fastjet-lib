...
plot \
     ...
     siscone(R,1) u 2:5 @ll 2 t "with UE", \
     siscone(R,1) u 2:13 @ll 3 t "<n_{PU}>=2.3"'

R=0.4
@plan
`gnupr siscone_R_dep_R0.4.eps cld`

R=0.5
@plan
`gnupr siscone_R_dep_R0.5.eps cld`

R=0.6
@plan
`gnupr siscone_R_dep_R0.6.eps cld`

R=0.7
@plan
`gnupr siscone_R_dep_R0.7.eps cld`

R=0.8
@plan
`gnupr siscone_R_dep_R0.8.eps cld`

R=1.0
@plan
`gnupr siscone_R_dep_R1.0.eps cld`
