...
plot \
     ...
     kt(R,1) u 2:13 @ll 3 t "<n_{PU}>=2.3"'

R=0.4
@plan
`gnupr kt_R_dep_R0.4.eps cld`

R=0.5
@plan
`gnupr kt_R_dep_R0.5.eps cld`

R=0.6
@plan
`gnupr kt_R_dep_R0.6.eps cld`

R=0.7
@plan
`gnupr kt_R_dep_R0.7.eps cld`

R=0.8
@plan
`gnupr kt_R_dep_R0.8.eps cld`
...
plot \
     kt(R,0) u 2:5 @ll 1 t "no UE", \
     kt(R,1) u 2:9 @ll 2 t "with UE (sub)", \
     kt(R,1) u 2:17 @ll 3 t "<n_{PU}>=2.3 (sub)"'

R=0.4
@plan
`gnupr kt_R_dep_sub_R0.4.eps cld`

R=0.5
@plan
`gnupr kt_R_dep_sub_R0.5.eps cld`

R=0.6
@plan
`gnupr kt_R_dep_sub_R0.6.eps cld`

R=0.7
@plan
`gnupr kt_R_dep_sub_R0.7.eps cld`

R=0.8
@plan
`gnupr kt_R_dep_sub_R0.8.eps cld`

R=1.0
@plan
`gnupr kt_R_dep_sub_R1.0.eps cld`
