...
set label 2 "[Pythia P_{t,min} = 10 GeV, unquenched]" at 10,1e-5

set label 3 "k_t alg, R=0.25" at graph 0.03,0.93
...
plot 'incplt_justhard_nhsel3_r0.25' u 1:($4*90) w st lt 2 lw 2 t 'scaled pp'
replot 'incplt_xcl_nhsel1_r0.25'        u 1:($7)    w st lt 3 lw 2 t 'raw Pb-Pb'
replot 'incplt_xcl_nhsel1_r0.25'        u 1:($9)    w st lt -1 lw 3 t 'Pb-Pb with subtraction'
