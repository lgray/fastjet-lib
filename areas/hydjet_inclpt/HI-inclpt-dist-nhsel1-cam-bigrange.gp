...
set label 3 "Cam/Aachen alg, R=0.4" at graph 0.03,0.93
...
plot 'incplt_justhard_nhsel3_cam_r0.4' u 1:(justbelow($4*90,$1,92)) w st lw 2 lt 2 t 'scaled pp'
replot 'incplt_justhard_ptminhard50_nhsel3_cam_r0.4' u 1:(justabove($4*rescalehard,$1,75)) w st lw 2 lt 2 t ''
...
replot 'incplt_xcl_nhsel1_cam_r0.4'        u 1:($7)    w st lw 2 lt 3 t 'raw Pb-Pb'
#replot 'incplt_nhsel1_cam_r0.4'        u 1:($9)    w st lw 2 lt 55 t 'Pb-Pb with subtraction'
replot 'incplt_xcl_nhsel1_cam_r0.4'        u 1:(justbelow($9,$1,140))    w st lw 3 lt -1 t 'Pb-Pb with subtraction'
replot 'incplt_xcl_ptminhard50_nhsel1_cam_r0.4'        u 1:(justabove($9*rescaleHI,$1,100))    w st lw 3 lt -1 t ''
