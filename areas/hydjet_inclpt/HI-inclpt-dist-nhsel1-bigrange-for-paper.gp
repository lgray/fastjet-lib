...
set macros
linenp ="lt  2 lw 3 lc rgb '#00a000'"
linenps="lt  1 lw 4"
linepu ="lt  3 lw 3"
linepus="lt -1 lw 3"


set label 1 "LHC, Pb Pb, {/Symbol \326}s = 5.5 TeV"  at 12,8e-6
set label 2 "Hydjet, dN_{ch}/dy = 1600" at 12,1e-6

set label 3 "k_t, R=0.4" at graph 0.03,0.93 front
...
set xlabel 'P_t [GeV]'
set ylabel '1/n_{coll} d n_{jets} / d P_t [GeV^{-1}]'
...
plot 'incplt_justhard_nhsel3_r0.4' u 1:(justbelow($4*90,$1,92)) w st @linenp t 'scaled pp'
replot 'incplt_justhard_ptminhard50_nhsel3_r0.4' u 1:(justabove($4*rescalehard,$1,70)) w st @linenp t ''
...
replot 'incplt_xcl_nhsel1_r0.4'        u 1:($7)    w st @linepu t 'raw Pb-Pb'
#replot 'incplt_nhsel1_r0.4'        u 1:($9)    w st lw 2 lt 55 t 'Pb-Pb with subtraction'
replot 'incplt_xcl_nhsel1_r0.4'        u 1:(justbelow($9,$1,140))    w st @linepus t 'Pb-Pb with subtraction'
replot 'incplt_xcl_ptminhard50_nhsel1_r0.4'        u 1:(justabove($9*rescaleHI,$1,100))    w st  @linepus t ''
