...
set size square
set key spacing 1.5
set key left Left reverse width -5

set ylabel '1/N dN/dm [GeV^{-1}]' offset 2,0
set xlabel 'reconstructed top mass [GeV]'

set label 2 'LHC (no pileup)' at graph 0.035,0.05 
set label 1 'Pythia'          at graph 0.965,0.05 right

plot 'kt_R0.5_bin2_long.res'  u 2:5 w l lt 2lw 3  t 'k_t',\
     'cam_R0.5_bin2_long.res' u 2:5 w l lt 3 lw 3 t 'Cam/Aachen',\
     'siscone_R0.5_f0.5_passive_RUK_bin2_long.res' u 2:5 w l lt 4 lw 3 t 'SISCone',\
