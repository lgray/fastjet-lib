...
set label 1 'FastJet CGAL N ln N' at 3.2e3,7.7e-5 center font "courier,bold,20"
set label 2 'measured timings versus fit of form (a + b ln N) N' at 3.2e3,7.35e-5 center font "Helvetica,20"

plot a + b*log(x) w l lt 2 lw 2 t ''
