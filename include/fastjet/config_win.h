#define FASTJET_PACKAGE_STRING  "FastJet 3.4.2-devel"
#define FASTJET_PACKAGE_VERSION  "3.4.2-devel"
#define FASTJET_VERSION  "3.4.2-devel"
...
#define FASTJET_VERSION_NUMBER      30402
