...
#ifndef __FASTJET_CLUSTER_SEQUENCE_INTERFACE_HH__
#define __FASTJET_CLUSTER_SEQUENCE_INTERFACE_HH__
...
public:
  ...
  /// ClusterSequence
  ClusterSequenceInterface(const ClusterSequence *cs){
...
#endif  //  __FASTJET_CLUSTER_SEQUENCE_INTERFACE_HH__
